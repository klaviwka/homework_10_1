...
def test_filter_by_state(transactions: List[Dict[str, Any]], input_state: str, expected_output: List[Dict[str, Any]]) -> None:
...
def test_sort_by_date(transactions: List[Dict[str, Any]], descending: bool, expected_order: List[Dict[str, Any]]) -> None:
